        ...
        <div className='max-width'>
            <div className='photo-section-child'>
                <div className='photo-section-top'>
                    <div className='photo-section-heading cred-experence-heading'>
                ...
                <div className='photo-section-bottom'>
                    <div className='photo-section-description cred-experence-description'>
                    never miss a due date with reminders to help you pay
                     your bills on time, instant settlements mean you 
                     never wait for your payments to go through and statement
